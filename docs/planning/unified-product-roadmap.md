...
| EXPAND-08 | P1 | Expansion tests | Cover mixed sizes, health blockers, parity needs, ZFS restrictions, stale discovery, and unsupported tools. | IN PROGRESS — existing-data, system-disk exclusion, mergerFS/SnapRAID, download-tier, matched-mirror, reservation persistence/system protection, API, component, and real-browser tests added; fault matrix pending |
