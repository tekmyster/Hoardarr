...
| VALID-04 | P2 | Backup and automation integration | Execute S3 outage/resume/checksum/restore and HA/webhook/metrics contract tests. | IN PROGRESS — Ubuntu 24.04 CI run `32685417436` completed live MinIO target proof, durable upload, full remote SHA-256 verification, download, safe extraction and SQLite restore validation; outage/resume plus future webhook/automation scenarios remain |
